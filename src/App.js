...
function createData(Coin, CurrentPrice, BolingerAverage, Percentage) {
    return { Coin, CurrentPrice, BolingerAverage, Percentage };
}
...
const headCells = [
    ...
    { id: 'CurrentPrice', numeric: true, disablePadding: false, label: 'CurrentPrice' },
    { id: 'BolingerAverage', numeric: true, disablePadding: false, label: 'BolingerAverage' },
...
export default function EnhancedTable() {
    ...
    const handleSelectAllClick = (event) => {
        if (event.target.checked) {
            const newSelecteds = FinalOutput.map((n) => n.name);
    ...
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, FinalOutput.length - page * rowsPerPage);
            ...
            getDataAsync()
                .then(data => {
                    Object.keys(data).map((coin) => {
                        ...
                        // var tempPrice = data[coin]["avgPrice"]
                        // var tempAverage = data[coin]["bollMiddle"]
                        // var temp = {coin, tempPrice, tempAverage , perdifference}
                        // rows.push(temp)
                    });
                    handleRequestSort()
            ...
            <Paper className={classes.paper}>
                ...
                <TableContainer>
                    ...
                    >
                        ...
                        />
                        <TableBody>
                            {stableSort(FinalOutput, getComparator(order, orderBy))
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{row.BolingerAverage}</TableCell>
